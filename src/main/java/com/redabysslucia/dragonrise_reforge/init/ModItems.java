...
public class ModItems {
    ...
    public static final DeferredHolder<Item, Item> CNJUSTCHEST = REGISTRY.register("cnjustchest", CNJustchest::new);
    ...
    public static final DeferredHolder<Item, Item> ARMY07HAT = REGISTRY.register("army07hat", Army07Hat::new);
