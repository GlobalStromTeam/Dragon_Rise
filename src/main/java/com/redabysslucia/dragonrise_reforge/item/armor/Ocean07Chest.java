...
import net.minecraft.world.item.component.ItemAttributeModifiers;import com.redabysslucia.dragonrise_reforge.client.model.armor.Ocean07ChestModel;
...
public class Ocean07Chest extends ArmorItem implements GeoItem {
        ...
        consumer.accept(new IClientItemExtensions() {
            ...
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (this.itemRenderer == null)
                    this.itemRenderer = new GeoItemRenderer<>(new Ocean07ChestModel());
