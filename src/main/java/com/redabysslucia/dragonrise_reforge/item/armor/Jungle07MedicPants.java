...
import com.redabysslucia.dragonrise_reforge.client.renderer.armor.Jungle07MedicPantsRenderer;
...
public class Jungle07MedicPants extends ArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public Jungle07MedicPants() {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            ...
            private GeoItemRenderer<Jungle07MedicPants> itemRenderer;

            @Override
            public HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
                if (this.renderer == null)
                    this.renderer = new Jungle07MedicPantsRenderer();
            ...
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (this.itemRenderer == null)
                    this.itemRenderer = new GeoItemRenderer<>(new Jungle07MedicPantsModel());
