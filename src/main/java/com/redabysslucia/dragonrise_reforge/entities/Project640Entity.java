...
public class Project640Entity extends NightVisionVehicle {
    public Project640Entity(EntityType<?> pEntityType, Level pLevel) {
    ...
    private PlayState cannonFirePredicate(AnimationState<Project640Entity> event) {
