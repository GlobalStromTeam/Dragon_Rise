...
public class J11Entity extends FireLightVisionVehicle {

    public J11Entity(EntityType<J11Entity> type, Level world) {
        super(type, world);
    }
    ...
    private PlayState Sb1(AnimationState<J11Entity> event) {
