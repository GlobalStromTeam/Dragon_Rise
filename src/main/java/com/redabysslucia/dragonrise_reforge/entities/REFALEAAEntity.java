...
public class REFALEAAEntity extends FireLightVisionVehicle {

    public REFALEAAEntity(EntityType<REFALEAAEntity> type, Level world) {
        super(type, world);
    }
    ...
    private PlayState Sb(AnimationState<REFALEAAEntity> event) {
        if (this.onGround()) {
    ...
    private PlayState Sb1(AnimationState<REFALEAAEntity> event) {
