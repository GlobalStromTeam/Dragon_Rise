...
public class ZTQ15Entity extends NightVisionVehicle {
    public ZTQ15Entity(EntityType<?> pEntityType, Level pLevel) {
    ...
    private PlayState cannonFirePredicate(AnimationState<ZTQ15Entity> event) {
