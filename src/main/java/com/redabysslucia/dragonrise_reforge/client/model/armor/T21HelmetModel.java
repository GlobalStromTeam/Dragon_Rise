...
public class T21HelmetModel extends GeoModel<T21Helmet> {
    ...
    public ResourceLocation getModelResource(T21Helmet object) {
        return ResourceLocation.fromNamespaceAndPath("dragonrise_reforge","geo/t21_helmet.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(T21Helmet object) {
        return ResourceLocation.fromNamespaceAndPath("dragonrise_reforge","textures/armor/t21_helmet.png");
    }
}