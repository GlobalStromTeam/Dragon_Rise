...
public class Jungle07MedicHelmetRenderer extends GeoArmorRenderer<Jungle07MedicHelmet> {
	public Jungle07MedicHelmetRenderer() {
		super(new Jungle07MedicHelmetModel());
	...
	@Override
	public RenderType getRenderType(Jungle07MedicHelmet animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
