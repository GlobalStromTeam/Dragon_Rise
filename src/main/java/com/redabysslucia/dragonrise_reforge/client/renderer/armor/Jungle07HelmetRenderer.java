...
public class Jungle07HelmetRenderer extends GeoArmorRenderer<Jungle07Helmet> {
	public Jungle07HelmetRenderer() {
		super(new Jungle07HelmetModel());
	...
	@Override
	public RenderType getRenderType(Jungle07Helmet animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
