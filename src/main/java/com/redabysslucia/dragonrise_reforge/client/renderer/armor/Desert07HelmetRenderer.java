...
public class Desert07HelmetRenderer extends GeoArmorRenderer<Desert07Helmet> {
	public Desert07HelmetRenderer() {
		super(new Desert07HelmetModel());
	...
	@Override
	public RenderType getRenderType(Desert07Helmet animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
