...
public class KR06ChestRenderer extends GeoArmorRenderer<KR06Chest> {
	public KR06ChestRenderer() {
		super(new KR06ChestModel());
	...
	@Override
	public RenderType getRenderType(KR06Chest animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
