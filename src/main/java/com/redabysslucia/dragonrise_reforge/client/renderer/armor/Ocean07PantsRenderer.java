...
public class Ocean07PantsRenderer extends GeoArmorRenderer<Ocean07Pants> {
	public Ocean07PantsRenderer() {
		super(new Ocean07PantsModel());
	...
	@Override
	public RenderType getRenderType(Ocean07Pants animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
