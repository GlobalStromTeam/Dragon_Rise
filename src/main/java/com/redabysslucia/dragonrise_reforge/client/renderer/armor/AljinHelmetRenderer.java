...
public class AljinHelmetRenderer extends GeoArmorRenderer<AljinHelmet> {
	public AljinHelmetRenderer() {
		super(new AljinHelmetModel());
	...
	@Override
	public RenderType getRenderType(AljinHelmet animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
