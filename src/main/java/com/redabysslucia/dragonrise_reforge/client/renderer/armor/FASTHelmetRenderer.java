...
public class FASTHelmetRenderer extends GeoArmorRenderer<FASTHelmet> {
	public FASTHelmetRenderer() {
		super(new FASTHelmetModel());
	...
	@Override
	public RenderType getRenderType(FASTHelmet animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
