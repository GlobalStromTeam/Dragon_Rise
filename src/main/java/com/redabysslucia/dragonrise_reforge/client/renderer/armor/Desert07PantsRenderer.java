...
public class Desert07PantsRenderer extends GeoArmorRenderer<Desert07Pants> {
	public Desert07PantsRenderer() {
		super(new Desert07PantsModel());
	...
	@Override
	public RenderType getRenderType(Desert07Pants animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
