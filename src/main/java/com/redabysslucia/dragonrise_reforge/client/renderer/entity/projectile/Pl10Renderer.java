...
/** PL-10 渲染器：复用 superb 的 SBM 投射物渲染器（模型/贴图按实体 id 自动解析）。 */
public class Pl10Renderer extends BasicProjectileRenderer<Pl10Entity> {

    public Pl10Renderer(EntityRendererProvider.Context context) {
        super(context);
    }
}
