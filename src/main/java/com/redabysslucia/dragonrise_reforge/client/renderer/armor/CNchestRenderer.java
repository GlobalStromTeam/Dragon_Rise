...
public class CNchestRenderer extends GeoArmorRenderer<CNchest> {
	public CNchestRenderer() {
		super(new CNchestModel());
	...
	@Override
	public RenderType getRenderType(CNchest animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
