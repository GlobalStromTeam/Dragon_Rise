...
public class Jungle07MedicChestRenderer extends GeoArmorRenderer<Jungle07MedicChest> {
	public Jungle07MedicChestRenderer() {
		super(new Jungle07MedicChestModel());
	...
	@Override
	public RenderType getRenderType(Jungle07MedicChest animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
