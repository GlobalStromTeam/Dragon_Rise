...
public class CNfastRenderer extends GeoArmorRenderer<CNfast> {
	public CNfastRenderer() {
		super(new CNfastModel());
	...
	@Override
	public RenderType getRenderType(CNfast animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
