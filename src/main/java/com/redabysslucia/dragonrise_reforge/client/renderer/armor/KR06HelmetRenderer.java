...
public class KR06HelmetRenderer extends GeoArmorRenderer<KR06Helmet> {
	public KR06HelmetRenderer() {
		super(new KR06HelmetModel());
	...
	@Override
	public RenderType getRenderType(KR06Helmet animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
