...
public class TJGCGlowLayer extends GeoRenderLayer<TJGCEntity> {

        private static final ResourceLocation LAYER = ResourceLocation.fromNamespaceAndPath("dragonrise_reforge","textures/entity/glow/tjgc_glow.png");

    public TJGCGlowLayer(GeoRenderer<TJGCEntity> entityRenderer) {
