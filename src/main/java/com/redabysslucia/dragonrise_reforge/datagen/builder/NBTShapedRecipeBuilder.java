package com.redabysslucia.dragonrise_reforge.datagen.builder;
...
public class NBTShapedRecipeBuilder extends CraftingRecipeBuilder implements RecipeBuilder {
    ...
    public void save(Consumer<FinishedRecipe> pFinishedRecipeConsumer, ResourceLocation pRecipeId) {
        ...
        pFinishedRecipeConsumer.accept(new Result(pRecipeId, this.result, this.count, this.group == null ? "" : this.group,
